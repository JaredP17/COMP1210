...
/**
 * Takes a Pet as a parameter and returns an int indicating
 * the ordering from lowest to highest based on the owner’s 
 * last name followed by first name.
 *
 * @param p for pet to be compared to
 * @return compared value
 */
   public int compareTo(Pet p) {
      Scanner scan = new Scanner(this.owner);
      scan.useDelimiter(" ");
      ...
      Scanner scan2 = new Scanner(p.owner);
      scan2.useDelimiter(" ");
      String firstName2 = scan2.next().toUpperCase();
      String lastName2 = scan2.next().toUpperCase();
      
      while (scan.hasNext()) {
         lastName2 += scan2.next().toUpperCase();
      }
